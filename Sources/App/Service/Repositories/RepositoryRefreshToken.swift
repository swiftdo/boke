...
protocol RepositoryRefreshToken: Repository {
...
struct DatabaseRepositoryRefreshToken: RepositoryRefreshToken, DatabaseRepository {
...
extension Application.Repositories {
    var refreshTokens: RepositoryRefreshToken {
    ...
    func use(_ make: @escaping (Application) -> (RepositoryRefreshToken)) {
